...
// Pokémon characters for the Pokémon story mode
const POKEMON_ENTITIES = [
  {
    "character": {
      ...
      "background": {
        "origin_story": "A Pikachu who was once wild but formed an unbreakable bond with its trainer.",
        "abilities": [
          "Thunderbolt",
          "Quick Attack",
          "Iron Tail",
      ...
      "relationships": {
        "trainer": "Ash Ketchum",
        "friends": ["Charmander", "Bulbasaur", "Squirtle"],
        "rivals": ["Raichu"]
      },
      "story_elements": {
        "motivation": "To become the strongest Pokémon and help its trainer become a Pokémon Master.",
        "character_arc": "From a stubborn Pikachu to a reliable and powerful partner.",
        "internal_conflict": "Struggles with trusting new trainers initially.",
        "external_conflict": "Facing stronger Pokémon and overcoming type disadvantages.",
        "symbolism": "Represents friendship and determination.",
        "theme": "The power of trust and perseverance."
      },
      "quirks": [
        "Loves ketchup",
        "Says 'Pika Pika' a lot",
        "Gets excited by thunderstones but refuses to evolve"
      ]
    }
  },
  {
    "character": {
      ...
      "role": "Powerful Ally",
      "physical_attributes": {
        "defining_feature": "Large orange draconic body with wings",
        "color_palette": {
          "body": "Orange",
          "wings": "Blue",
          "belly": "Cream"
      ...
      "background": {
        "origin_story": "Started as a rebellious Charmander, evolved through battles and challenges.",
        "abilities": [
          "Flamethrower",
          "Dragon Claw",
          "Air Slash",
      ...
      "relationships": {
        "trainer": "Ash Ketchum",
        "friends": ["Pikachu", "Bulbasaur", "Squirtle"],
        "rivals": ["Blastoise", "Venusaur"]
      },
      "story_elements": {
        "motivation": "To become the strongest Fire-type Pokémon.",
        "character_arc": "From a disobedient Pokémon to a reliable team member.",
        "internal_conflict": "Struggles with pride and following orders.",
        "external_conflict": "Facing stronger opponents and overcoming type disadvantages.",
        "symbolism": "Represents strength and personal growth.",
        "theme": "The importance of discipline and teamwork."
      },
      "quirks": [
        "Likes to nap in the sun",
        "Enjoys flying at high altitudes",
  ...
  },
  {
    "character": {
      ...
      "type": ["Psychic"],
      "gender": "Genderless",
      "role": "Mysterious Antagonist",
      "physical_attributes": {
        "defining_feature": "Humanoid feline with a long tail and purple skin",
        "color_palette": {
          "body": "Pale Purple",
          "eyes": "Purple",
          "underside": "Purple"
      ...
      "background": {
        "origin_story": "Created through genetic engineering, Mewtwo struggles with its purpose and existence.",
        "abilities": [
          "Psychic",
          "Shadow Ball",
          "Aura Sphere",
      ...
      "relationships": {
        "creator": "Dr. Fuji",
        "enemies": ["Humans who seek to control it"],
        "allies": ["Other genetically modified Pokémon"]
      },
      "story_elements": {
        "motivation": "To understand its purpose and find its place in the world.",
        "character_arc": "From a vengeful creation to a more understanding being.",
        "internal_conflict": "Struggles with its artificial nature and purpose.",
        "external_conflict": "Battling against those who seek to control it.",
        "symbolism": "Represents the ethical dilemmas of scientific advancement.",
        "theme": "The nature of humanity and existence."
      },
      "quirks": [
        "Speaks telepathically",
        "Prefers solitude",
        "Highly intelligent and philosophical"
      ]
    }
  }
];
